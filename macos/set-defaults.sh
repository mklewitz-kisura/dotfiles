...
# initial file copied from Matthias Bynens 
...
# Always show scrollbars => I'll leave this at "WhenScrolling"
...
# Never go into computer sleep mode => I want the computer to go into sleep mode
...
# The following 3 tweaks require to boot up in recovery more (⌘+R during boot)
# and then go into terminal and enter `csrutil disable` for deactivating the
...
# Set a faster keyboard repeat rate (defaults are InitialKeyRepeat = 25 and KeyRepeat = 6)
# I would say that these are milliseconds
...
# The following line doesn't seen to work on Mojave :/
...
# I don't have this theme and it should be part of the repo
